...
<h3 align="center">SPEED QUIZ DApp</h3>

</div>

![-----------------------------------------------------](https://raw.githubusercontent.com/andreasbm/readme/master/assets/lines/cloudy.png)

Here is the Live deployment [link](https://algo-speed-quiz.netlify.app)

Here's a demo quiz [url](https://algo-speed-quiz.netlify.app/quiz?quizId=Quiz-118504956)

Simple application that allows users create and partake in speed quizzes. To access a quiz, the user will use the quiz ID, which makes the quiz somewhat permissioned as only those with the quiz ID can partake in that quiz (...PRIVACY... LOL). Creation of quiz is free, but for each question added a fee of 1 algo is collected and sent to the quiz contract. For a player to take the quiz,  the player must opt in and then pay a fee of 1 algo and if the player meets the pass percent the reward is 2 times the start fee. Rewards are given to fast quizzers, with the aid of a benchmark and for a twist for every wrong answer the player picks he loses 10 seconds.
